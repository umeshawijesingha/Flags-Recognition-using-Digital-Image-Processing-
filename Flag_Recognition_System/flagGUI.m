...
% Last Modified by GUIDE v2.5 13-Sep-2022 16:19:17
...
function flagGUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
% UIWAIT makes flagGUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = flagGUI_OutputFcn(hObject, eventdata, handles) 
...
result = countryflagRecognition(image);
